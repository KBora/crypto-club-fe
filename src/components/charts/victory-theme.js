...
const blueGrey700 = "rgb(107, 114, 128)";
const grey900 = "#212121";

// Typography
const sansSerif = "Inter, 'Helvetica Neue', 'Helvetica', sans-serif";
...
const baseProps = {
  width: 350,
  height: 350,
  padding: { top: 5, left: 50, right: 50, bottom: 25 }
};
